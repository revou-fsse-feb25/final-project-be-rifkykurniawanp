...
-- DropForeignKey
ALTER TABLE "public"."cart_items" DROP CONSTRAINT "cart_items_item_id_course_fkey";

-- DropForeignKey
ALTER TABLE "public"."cart_items" DROP CONSTRAINT "cart_items_item_id_product_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."course_enrollments" DROP CONSTRAINT "course_enrollments_payment_id_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."payments" DROP CONSTRAINT "payments_cart_id_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."product_orders" DROP CONSTRAINT "product_orders_payment_id_fkey";
...
-- DropEnum
DROP TYPE "public"."PermissionName";
...
-- AddForeignKey
ALTER TABLE "public"."CourseDetail" ADD CONSTRAINT "CourseDetail_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "public"."Course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
