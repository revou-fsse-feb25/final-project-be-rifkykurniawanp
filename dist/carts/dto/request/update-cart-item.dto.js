...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 3, description: 'New quantity', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 30000, description: 'New price per unit', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsPositive)(),
    __metadata("design:type", Number)
