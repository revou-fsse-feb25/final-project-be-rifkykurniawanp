...
const supplier_response_dto_1 = require("./supplier.response.dto");
const product_review_response_dto_1 = require("./product-review.response.dto");
...
__decorate([
    (0, swagger_1.ApiProperty)({ type: () => supplier_response_dto_1.SupplierResponseDto }),
    __metadata("design:type", supplier_response_dto_1.SupplierResponseDto)
], ProductResponseDto.prototype, "supplier", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: () => product_review_response_dto_1.ProductReviewResponseDto, isArray: true }),
    __metadata("design:type", Array)
