...
let ProductsController = class ProductsController {
    ...
    findAll(page = 1, limit = 10, category, origin, status, supplierId, minPrice, maxPrice) {
        const filter = {
            category,
            origin,
            status,
...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({ description: 'The product has been successfully created.', type: product_response_dto_1.ProductResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'category', required: false, enum: client_1.ProductCategory, description: 'Filter by product category' }),
    (0, swagger_1.ApiQuery)({ name: 'origin', required: false, enum: client_1.ProductOrigin, description: 'Filter by product origin' }),
    (0, swagger_1.ApiQuery)({ name: 'status', required: false, enum: client_1.ProductStatus, description: 'Filter by product status' }),
    (0, swagger_1.ApiQuery)({ name: 'supplierId', required: false, description: 'Filter by supplier ID', type: 'number' }),
    (0, swagger_1.ApiQuery)({ name: 'minPrice', required: false, description: 'Filter by minimum price', type: 'number' }),
    (0, swagger_1.ApiQuery)({ name: 'maxPrice', required: false, description: 'Filter by maximum price', type: 'number' }),
    __param(0, (0, common_1.Query)('page', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Query)('limit', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Query)('category')),
    __param(3, (0, common_1.Query)('origin')),
    __param(4, (0, common_1.Query)('status')),
    __param(5, (0, common_1.Query)('supplierId', common_1.ParseIntPipe)),
    __param(6, (0, common_1.Query)('minPrice', common_1.ParseIntPipe)),
    __param(7, (0, common_1.Query)('maxPrice', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, String, String, String, Number, Number, Number]),
    __metadata("design:returntype", Promise)
