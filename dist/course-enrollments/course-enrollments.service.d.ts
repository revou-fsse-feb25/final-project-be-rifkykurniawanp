...
export declare class CourseEnrollmentsService {
    ...
    constructor(repository: CourseEnrollmentsRepository);
    enroll(dto: EnrollCourseDto, paymentId: number): import(".prisma/client").Prisma.Prisma__CourseEnrollmentClient<{
        id: number;
        courseId: number;
        paymentId: number;
        studentId: number;
